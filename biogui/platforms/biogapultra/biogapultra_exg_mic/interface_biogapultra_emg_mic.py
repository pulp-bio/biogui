...
_EMG_FS          = 500.0                  # Hz, per channel
_EMG_PACKET_RATE = _EMG_FS / _N_SAMPLES   # 125 packets/s
...
sigInfo: dict = {
    "emg_A": {"fs": _EMG_FS, "nCh": _N_CH, "extras": {"type": "time-series"}},
    "emg_B": {"fs": _EMG_FS, "nCh": _N_CH, "extras": {"type": "time-series"}},
    ...
    "emg_counter":   {"fs": _EMG_PACKET_RATE, "nCh": 1, "extras": {"type": "time-series", "plotByDefault": False}},
    "emg_timestamp": {"fs": _EMG_PACKET_RATE, "nCh": 1, "extras": {"type": "time-series", "plotByDefault": False}},
...
"""Signal definitions: two 8-channel EMG streams (µV) at 500 Hz, mono microphone
