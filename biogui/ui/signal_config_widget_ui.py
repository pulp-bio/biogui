...
class Ui_SignalConfigWidget(object):
    def setupUi(self, SignalConfigWidget):
        ...
        self.formLayout2.setWidget(0, QFormLayout.FieldRole, self.chSpacingTextField)

        self.showYAxisCheckBox = QCheckBox(self.plotGroupBox)
        self.showYAxisCheckBox.setObjectName(u"showYAxisCheckBox")

        self.formLayout2.setWidget(1, QFormLayout.FieldRole, self.showYAxisCheckBox)
        ...
        self.formLayout2.setWidget(2, QFormLayout.FieldRole, self.rangeModeComboBox)

        self.label5 = QLabel(self.plotGroupBox)
        self.label5.setObjectName(u"label5")

        self.formLayout2.setWidget(2, QFormLayout.LabelRole, self.label5)

        self.label6 = QLabel(self.plotGroupBox)
        self.label6.setObjectName(u"label6")
        self.label6.setEnabled(False)

        self.formLayout2.setWidget(3, QFormLayout.LabelRole, self.label6)
        ...
        self.formLayout2.setWidget(3, QFormLayout.FieldRole, self.minRangeTextField)

        self.label7 = QLabel(self.plotGroupBox)
        self.label7.setObjectName(u"label7")
        self.label7.setEnabled(False)

        self.formLayout2.setWidget(4, QFormLayout.LabelRole, self.label7)
        ...
        self.formLayout2.setWidget(4, QFormLayout.FieldRole, self.maxRangeTextField)
        ...
        self.formLayout3.setFieldGrowthPolicy(QFormLayout.ExpandingFieldsGrow)
        self.label8 = QLabel(self.filterGroupBox)
        self.label8.setObjectName(u"label8")
        self.label8.setFrameShape(QFrame.NoFrame)

        self.formLayout3.setWidget(0, QFormLayout.LabelRole, self.label8)
        ...
        self.formLayout3.setWidget(0, QFormLayout.FieldRole, self.filtTypeComboBox)
        ...
        self.formLayout3.setWidget(1, QFormLayout.FieldRole, self.freq1TextField)
        ...
        self.formLayout3.setWidget(2, QFormLayout.FieldRole, self.freq2TextField)
        ...
        self.formLayout3.setWidget(3, QFormLayout.FieldRole, self.filtOrderTextField)
        ...
        self.notchFilterGroupBox.setAlignment(Qt.AlignCenter)
        ...
        self.formLayout4.setFieldGrowthPolicy(QFormLayout.ExpandingFieldsGrow)
        ...
        self.formLayout4.setWidget(0, QFormLayout.FieldRole, self.notchFreqComboBox)
        ...
        self.formLayout4.setWidget(1, QFormLayout.FieldRole, self.qFactorTextField)
