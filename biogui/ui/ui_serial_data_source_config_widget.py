...
class Ui_SerialDataSourceConfigWidget(object):
    def setupUi(self, SerialDataSourceConfigWidget):
        if not SerialDataSourceConfigWidget.objectName():
            SerialDataSourceConfigWidget.setObjectName("SerialDataSourceConfigWidget")
    ...
    def retranslateUi(self, SerialDataSourceConfigWidget):
        SerialDataSourceConfigWidget.setWindowTitle(
            QCoreApplication.translate(
                "SerialDataSourceConfigWidget", "Serial Data Source Configuration", None
            )
        )
        self.label1.setText(
            QCoreApplication.translate(
                "SerialDataSourceConfigWidget", "Serial port:", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.serialPortsComboBox.setToolTip(
            QCoreApplication.translate(
                "SerialDataSourceConfigWidget", "List of available serial ports", None
            )
        )
        ...
        self.rescanSerialPortsButton.setToolTip(
            QCoreApplication.translate(
                "SerialDataSourceConfigWidget", "Rescan serial ports", None
            )
        )
        # endif // QT_CONFIG(tooltip)
