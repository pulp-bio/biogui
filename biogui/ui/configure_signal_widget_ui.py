...
################################################################################
## Form generated from reading UI file 'configure_signal_widget.ui'
##
...
class Ui_ConfigureSignalWidget(object):
    def setupUi(self, ConfigureSignalWidget):
        if not ConfigureSignalWidget.objectName():
            ConfigureSignalWidget.setObjectName(u"ConfigureSignalWidget")
        ConfigureSignalWidget.resize(400, 500)
        self.verticalLayout = QVBoxLayout(ConfigureSignalWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.formLayout1 = QFormLayout()
        self.formLayout1.setObjectName(u"formLayout1")
        self.label1 = QLabel(ConfigureSignalWidget)
        self.label1.setObjectName(u"label1")

        self.formLayout1.setWidget(0, QFormLayout.LabelRole, self.label1)

        self.sigNameLabel = QLabel(ConfigureSignalWidget)
        self.sigNameLabel.setObjectName(u"sigNameLabel")

        self.formLayout1.setWidget(0, QFormLayout.FieldRole, self.sigNameLabel)

        self.label2 = QLabel(ConfigureSignalWidget)
        self.label2.setObjectName(u"label2")

        self.formLayout1.setWidget(1, QFormLayout.LabelRole, self.label2)

        self.nChLabel = QLabel(ConfigureSignalWidget)
        self.nChLabel.setObjectName(u"nChLabel")

        self.formLayout1.setWidget(1, QFormLayout.FieldRole, self.nChLabel)

        self.label3 = QLabel(ConfigureSignalWidget)
        self.label3.setObjectName(u"label3")

        self.formLayout1.setWidget(2, QFormLayout.LabelRole, self.label3)

        self.freqLabel = QLabel(ConfigureSignalWidget)
        ...
        self.filteringGroupBox = QGroupBox(ConfigureSignalWidget)
        ...
        self.plotGroupBox = QGroupBox(ConfigureSignalWidget)
        ...
        self.retranslateUi(ConfigureSignalWidget)

        QMetaObject.connectSlotsByName(ConfigureSignalWidget)
    # setupUi

    def retranslateUi(self, ConfigureSignalWidget):
        ConfigureSignalWidget.setWindowTitle(QCoreApplication.translate("ConfigureSignalWidget", u"Configure signal", None))
        self.label1.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Name:", None))
        self.sigNameLabel.setText("")
        self.label2.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Number of channels:", None))
        self.nChLabel.setText("")
        self.label3.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Sampling frequency (in sps):", None))
        self.freqLabel.setText("")
#if QT_CONFIG(tooltip)
        self.filteringGroupBox.setToolTip(QCoreApplication.translate("ConfigureSignalWidget", u"Only for visualization, the raw signal will be saved to file", None))
#endif // QT_CONFIG(tooltip)
        self.filteringGroupBox.setTitle(QCoreApplication.translate("ConfigureSignalWidget", u"Configure filtering", None))
        self.label4.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Type:", None))
        self.filtTypeComboBox.setItemText(0, QCoreApplication.translate("ConfigureSignalWidget", u"highpass", None))
        self.filtTypeComboBox.setItemText(1, QCoreApplication.translate("ConfigureSignalWidget", u"lowpass", None))
        self.filtTypeComboBox.setItemText(2, QCoreApplication.translate("ConfigureSignalWidget", u"bandpass", None))
        self.filtTypeComboBox.setItemText(3, QCoreApplication.translate("ConfigureSignalWidget", u"bandstop", None))

        self.label5.setText(QCoreApplication.translate("ConfigureSignalWidget", u"First critical frequency (in sps):", None))
#if QT_CONFIG(tooltip)
        self.freq1TextField.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.freq1TextField.setPlaceholderText("")
        self.label6.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Second critical frequency (in sps):", None))
#if QT_CONFIG(tooltip)
        self.freq2TextField.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.freq2TextField.setPlaceholderText(QCoreApplication.translate("ConfigureSignalWidget", u"For bandpass and bandstop only", None))
        self.label7.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Filter order:", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.plotGroupBox.setTitle(QCoreApplication.translate("ConfigureSignalWidget", u"Configure plot", None))
        self.label8.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Channel spacing (in a.u.):", None))
#if QT_CONFIG(tooltip)
        self.chSpacingTextField.setToolTip(QCoreApplication.translate("ConfigureSignalWidget", u"Spacing between the channels in the signal unit (only for multi-channel signals)", None))
#endif // QT_CONFIG(tooltip)
        self.chSpacingTextField.setText(QCoreApplication.translate("ConfigureSignalWidget", u"0", None))
        self.chSpacingTextField.setPlaceholderText("")
        self.showYAxisCheckBox.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Show Y axis", None))
        self.label9.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Range mode:", None))
        self.rangeModeComboBox.setItemText(0, QCoreApplication.translate("ConfigureSignalWidget", u"Automatic", None))
        self.rangeModeComboBox.setItemText(1, QCoreApplication.translate("ConfigureSignalWidget", u"Manual", None))

        self.label10.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Minimum range (in a.u.):", None))
        self.label11.setText(QCoreApplication.translate("ConfigureSignalWidget", u"Maximum range (in a.u.):", None))
    # retranslateUi
