...
class Ui_WulpusConfigWidget(object):
    def setupUi(self, WulpusConfigWidget):
        ...
        WulpusConfigWidget.resize(600, 700)
        ...
        self.numAcqsLabel = QLabel(self.basicTab)
        self.numAcqsLabel.setObjectName(u"numAcqsLabel")

        self.basicFormLayout.setWidget(0, QFormLayout.ItemRole.LabelRole, self.numAcqsLabel)

        self.numAcqsLineEdit = QLineEdit(self.basicTab)
        self.numAcqsLineEdit.setObjectName(u"numAcqsLineEdit")

        self.basicFormLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.numAcqsLineEdit)

        self.dcdcTurnonLabel = QLabel(self.basicTab)
        self.dcdcTurnonLabel.setObjectName(u"dcdcTurnonLabel")

        self.basicFormLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.dcdcTurnonLabel)

        self.dcdcTurnonLineEdit = QLineEdit(self.basicTab)
        self.dcdcTurnonLineEdit.setObjectName(u"dcdcTurnonLineEdit")

        self.basicFormLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.dcdcTurnonLineEdit)

        self.measPeriodLabel = QLabel(self.basicTab)
        self.measPeriodLabel.setObjectName(u"measPeriodLabel")

        self.basicFormLayout.setWidget(2, QFormLayout.ItemRole.LabelRole, self.measPeriodLabel)

        self.measPeriodLineEdit = QLineEdit(self.basicTab)
        self.measPeriodLineEdit.setObjectName(u"measPeriodLineEdit")

        self.basicFormLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.measPeriodLineEdit)

        self.transFreqLabel = QLabel(self.basicTab)
        self.transFreqLabel.setObjectName(u"transFreqLabel")

        self.basicFormLayout.setWidget(3, QFormLayout.ItemRole.LabelRole, self.transFreqLabel)

        self.transFreqLineEdit = QLineEdit(self.basicTab)
        self.transFreqLineEdit.setObjectName(u"transFreqLineEdit")

        self.basicFormLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.transFreqLineEdit)

        self.pulseFreqLabel = QLabel(self.basicTab)
        self.pulseFreqLabel.setObjectName(u"pulseFreqLabel")

        self.basicFormLayout.setWidget(4, QFormLayout.ItemRole.LabelRole, self.pulseFreqLabel)

        self.pulseFreqLineEdit = QLineEdit(self.basicTab)
        self.pulseFreqLineEdit.setObjectName(u"pulseFreqLineEdit")

        self.basicFormLayout.setWidget(4, QFormLayout.ItemRole.FieldRole, self.pulseFreqLineEdit)

        self.numPulsesLabel = QLabel(self.basicTab)
        self.numPulsesLabel.setObjectName(u"numPulsesLabel")

        self.basicFormLayout.setWidget(5, QFormLayout.ItemRole.LabelRole, self.numPulsesLabel)

        self.numPulsesLineEdit = QLineEdit(self.basicTab)
        self.numPulsesLineEdit.setObjectName(u"numPulsesLineEdit")

        self.basicFormLayout.setWidget(5, QFormLayout.ItemRole.FieldRole, self.numPulsesLineEdit)

        self.samplingFreqLabel = QLabel(self.basicTab)
        self.samplingFreqLabel.setObjectName(u"samplingFreqLabel")

        self.basicFormLayout.setWidget(6, QFormLayout.ItemRole.LabelRole, self.samplingFreqLabel)

        self.samplingFreqComboBox = QComboBox(self.basicTab)
        self.samplingFreqComboBox.setObjectName(u"samplingFreqComboBox")

        self.basicFormLayout.setWidget(6, QFormLayout.ItemRole.FieldRole, self.samplingFreqComboBox)

        self.numSamplesLabel = QLabel(self.basicTab)
        self.numSamplesLabel.setObjectName(u"numSamplesLabel")

        self.basicFormLayout.setWidget(7, QFormLayout.ItemRole.LabelRole, self.numSamplesLabel)

        self.numSamplesLineEdit = QLineEdit(self.basicTab)
        self.numSamplesLineEdit.setObjectName(u"numSamplesLineEdit")

        self.basicFormLayout.setWidget(7, QFormLayout.ItemRole.FieldRole, self.numSamplesLineEdit)

        self.rxGainLabel = QLabel(self.basicTab)
        self.rxGainLabel.setObjectName(u"rxGainLabel")

        self.basicFormLayout.setWidget(8, QFormLayout.ItemRole.LabelRole, self.rxGainLabel)

        self.rxGainComboBox = QComboBox(self.basicTab)
        self.rxGainComboBox.setObjectName(u"rxGainComboBox")

        self.basicFormLayout.setWidget(8, QFormLayout.ItemRole.FieldRole, self.rxGainComboBox)
        ...
        self.txRxTableWidget.setSelectionBehavior(QAbstractItemView.SelectRows)
...
#endif // QT_CONFIG(tooltip)
        self.numAcqsLabel.setText(QCoreApplication.translate("WulpusConfigWidget", u"Number of Acquisitions:", None))
#if QT_CONFIG(tooltip)
        self.numAcqsLabel.setToolTip(QCoreApplication.translate("WulpusConfigWidget", u"Total number of acquisitions to perform (0-10000000)", None))
#endif // QT_CONFIG(tooltip)
        self.numAcqsLineEdit.setText(QCoreApplication.translate("WulpusConfigWidget", u"2000", None))
