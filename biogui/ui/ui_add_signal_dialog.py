    ...
    def retranslateUi(self, AddSignalDialog):
        ...
        self.sigNameTextField.setToolTip(
            QCoreApplication.translate(
                "AddSignalDialog",
                "Name of the signal to display in the GUI (must be unique)",
                None,
            )
        )
        ...
        self.label6.setText(
            QCoreApplication.translate(
                "AddSignalDialog", "First critical frequency (in sps):", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.label7.setText(
            QCoreApplication.translate(
                "AddSignalDialog", "Second critical frequency (in sps):", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.fileSavingGroupBox.setTitle(
            QCoreApplication.translate("AddSignalDialog", "Configure file saving", None)
        )
        self.browseOutDirButton.setText(
            QCoreApplication.translate("AddSignalDialog", "Browse", None)
        )
        self.label9.setText(
            QCoreApplication.translate(
                "AddSignalDialog", "Directory where the file will be saved:", None
            )
        )
        self.label10.setText(
            QCoreApplication.translate("AddSignalDialog", "Path to directoy:", None)
        )
        self.outDirPathLabel.setText("")
        self.label11.setText(
            QCoreApplication.translate("AddSignalDialog", "File name:", None)
        )
        # if QT_CONFIG(tooltip)
        self.fileNameTextField.setToolTip(
            QCoreApplication.translate(
                "AddSignalDialog",
                "If empty, a name based on the timestamp will be employed",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.label14.setText(
            QCoreApplication.translate(
                "AddSignalDialog", "Channel spacing (in a.u.):", None
            )
        )
        # if QT_CONFIG(tooltip)
