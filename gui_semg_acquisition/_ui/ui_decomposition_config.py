...
class Ui_DecompositionConfig(object):
    def setupUi(self, DecompositionConfig):
        if not DecompositionConfig.objectName():
            DecompositionConfig.setObjectName(u"DecompositionConfig")
        ...
        self.decompGroupBox.setObjectName(u"decompGroupBox")
        ...
        self.gammaTextField.setObjectName(u"gammaTextField")
        ...
        self.browseDecompModelButton.setObjectName(u"browseDecompModelButton")
        ...
        self.lambdaTextField.setObjectName(u"lambdaTextField")
        ...
        self.decompModelLabel.setObjectName(u"decompModelLabel")
    ...
    def retranslateUi(self, DecompositionConfig):
        DecompositionConfig.setWindowTitle(QCoreApplication.translate("DecompositionConfig", u"Decomposition Widget", None))
        self.decompGroupBox.setTitle(QCoreApplication.translate("DecompositionConfig", u"Decomposition", None))
#if QT_CONFIG(tooltip)
        self.gammaTextField.setToolTip(QCoreApplication.translate("DecompositionConfig", u"If a non-numeric value is set, the default value will be used", None))
#endif // QT_CONFIG(tooltip)
        self.gammaTextField.setPlaceholderText(QCoreApplication.translate("DecompositionConfig", u"0.0", None))
        self.label1.setText(QCoreApplication.translate("DecompositionConfig", u"Initial forgetting factor:", None))
        self.label2.setText(QCoreApplication.translate("DecompositionConfig", u"Decaying factor:", None))
        self.browseDecompModelButton.setText(QCoreApplication.translate("DecompositionConfig", u"Browse", None))
        self.label3.setText(QCoreApplication.translate("DecompositionConfig", u"Decomposition model:", None))
        self.lambdaTextField.setPlaceholderText(QCoreApplication.translate("DecompositionConfig", u"0.001", None))
